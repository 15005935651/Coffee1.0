...
public class RadarView extends View {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        mTextSize = a.getDimension(R.styleable.RadarView_android_textSize,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_SP,40,getDisplayMetrics()));
        ...
        mLabelTextSize = a.getDimension(R.styleable.RadarView_labelTextSize,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_SP,16,getDisplayMetrics()));
        ...
        mTextOffsetY = a.getDimension(R.styleable.RadarView_textOffsetY,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_DIP,12,getDisplayMetrics()));
        mLabelTextOffseY = a.getDimension(R.styleable.RadarView_labelTextOffsetY,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_DIP,36,getDisplayMetrics()));
        ...
        mInsideStrokeWidth = a.getDimension(R.styleable.RadarView_insideStrokeWidth,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_DIP,3,getDisplayMetrics()));
        mOutsideStrokeWidth = a.getDimension(R.styleable.RadarView_outsideStrokeWidth,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_DIP,8,getDisplayMetrics()));
        mLineStrokeWidth = a.getDimension(R.styleable.RadarView_lineStrokeWidth,TypedValue.applyDimension
                (TypedValue.COMPLEX_UNIT_DIP,0.3f,getDisplayMetrics()));
        a.recycle();
    }
    ...
    private void  drawRadar(Canvas canvas){
        ...
        if(mIsShowLine){//是否绘制对角线和斜对角线
            ...
            // 绘制0°~180°对角线
            canvas.drawLine(mCircleCenterX - lineRadius, mCircleCenterY, mCircleCenterX + lineRadius, mCircleCenterY,
                    mPaint);
            // 绘制90°~270°对角线
            canvas.drawLine(mCircleCenterX, mCircleCenterY - lineRadius, mCircleCenterX, mCircleCenterY + lineRadius,
                    mPaint);
        ...
        //绘制圆扫描区域的渐变着色器
        if (mScanShader == null){
            mScanShader = new SweepGradient(mCircleCenterX, mCircleCenterY,new int[]
                    {Color.TRANSPARENT,Color.TRANSPARENT, mCircleColor},null);
        }
