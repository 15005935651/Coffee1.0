...
public class DashboardView extends View {
    ...
    private void init() {
        ...
        mBgColors = new int[]{ContextCompat.getColor(getContext(), R.color.colorGreen),
                ContextCompat.getColor(getContext(), R.color.ast_red),
                ContextCompat.getColor(getContext(), R.color.ast_yellow),
